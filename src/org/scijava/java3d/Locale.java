...
Vector<BranchGroup> branchGroups = new Vector<BranchGroup>();
     ...
     * </ul>
     *
     * @see BranchGroup#pickAll(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
     ...
     * </ul>
     *
     * @see BranchGroup#pickAllSorted(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
     ...
     * </ul>
     *
     * @see BranchGroup#pickClosest(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
     ...
     * </ul>
     *
     * @see BranchGroup#pickAny(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
