...
public class BranchGroup extends Group {
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickAll(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickAllSorted(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
   ...
   */
     ...
     * </ul>
     *
     * @see Locale#pickAny(int,int,org.scijava.java3d.PickShape)
     * @see PickInfo
     *
     * @since Java 3D 1.4
     *
